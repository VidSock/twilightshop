...
<CustomBox>
    ...
    <div style={{position:'absolute', top:'', fontSize:'10vw', color:'white', zIndex:'2', display:'flex', justifyContent:'center', alignItems:'center', border:'0px solid blue', width:'100vw'}}>Milky Way
    </div>
